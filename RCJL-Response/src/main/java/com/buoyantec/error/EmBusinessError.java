...
public enum EmBusinessError  implements CommonError{
    ...
    PERMISSIONS_NOT_PER(20005,"您暂无权限执行此命令"),
    USER_TOKEN_NULL(20006,"此接口需访问需令牌,请联系系统管理员处理"),

    //30000企业错误类型
    Enterprise_Not_Null(30001,"企业信息不能为空"),
    Enterprise_ID_NUll(30002,"企业与用户ID不能为空"),
    ENTERPRISE_NULL(30003,"用户无关联企业信息"),

    //添加新闻的报错
    NEWS_ERROR(40001,"添加新闻时发生错误,请联系管理员处理"),
    NEWS_NULL(40002,"您要查找新闻不存在,或已被删除"),
    News_ID_NULL(40003,"新闻ID不能为空"),


    //职位招聘相关的报错
    JOB_ERROR(50001,"职位未找到")
